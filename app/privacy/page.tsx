          ...
          <div className="prose prose-invert max-w-none space-y-6">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mt-2">
                ...
                <li>Логин или ID игрового аккаунта (например, Steam ID или PUBG Mobile ID)</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mt-2">
                <li>Обработки платежей и пополнения аккаунтов</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mt-2">
                ...
                <li>
                  Партнёрам (например, поставщикам игровых услуг) исключительно для выполнения
                  заказа
                </li>
