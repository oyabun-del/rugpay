          ...
          <div className="prose prose-invert max-w-none space-y-6">
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                сервиса по пополнению игровых аккаунтов и продаже цифровых подарочных карт
                (далее — «Сервис») заключить договор на оказание услуг.
              </p>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Сервис предоставляет услуги по пополнению баланса игровых аккаунтов и продаже
                цифровых подарочных карт, включая, но не ограничиваясь:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mt-2">
                <li>Пополнение баланса Steam</li>
                <li>Пополнение UC в PUBG Mobile</li>
                <li>Продажа подарочных карт Apple Gift Card (различных регионов и номиналов)</li>
              </ul>
              <p className="text-muted-foreground mt-2">
                Сервис не является официальным представителем указанных платформ (Valve, Tencent, Apple и др.).
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>3.1. Пользователь выбирает услугу и указывает необходимые данные (например, ID аккаунта, email для получения подарочной карты).</li>
                ...
                <li>3.4. Для подарочных карт Apple Gift Card: код карты отправляется на указанный email после успешной оплаты. Регион активации карты должен совпадать с регионом Apple&nbsp;ID пользователя.</li>
                <li>3.5. Сервис вправе запросить дополнительные данные для выполнения заказа.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li className="ml-4">код подарочной карты был доставлен и/или активирован</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li className="ml-4">ошибки, допущенные Пользователем при вводе данных (в том числе неверный email или несовпадение региона Apple&nbsp;ID с регионом карты)</li>
                <li className="ml-4">ограничения со стороны игровых платформ или Apple</li>
                <li className="ml-4">
