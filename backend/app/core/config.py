...
class Settings(BaseSettings):
    ...
    # Legacy PlayWallet Steam Top-Up API (disabled, kept for rollback/reference)
    PLAYWALLET_API_URL: Optional[str] = None
    PLAYWALLET_API_KEY: Optional[str] = None
    PLAYWALLET_SERVICE_ID: Optional[str] = None
    PLAYWALLET_RUB_PER_USD: float = Field(default=86.22, validation_alias="PLAYWALLET_RUB_PER_USD")
